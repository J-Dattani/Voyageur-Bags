...
<main class="main-content">
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-12">
          <h2 class="page-title">Marketing
          </h2>
          <div class="card shadow mb-4">
            <div class="card-header">
              <strong class="card-title">Add Tagline</strong>
            </div>
  ...
  unset($_SESSION['status_code']);
            ...
            <form  enctype="multipart/form-data" action="tagline_conn.php" method="post">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                    <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                            ...
                            <textarea class="form-control form-size" id="tagline" name="tagline" placeholder="Add Tagline here...." rows="4"></textarea>
                          </div>          
                </div> <!-- /.col -->
                </div>
