...
if (isset($_GET['category_id']) && !empty($_GET['category_id'])) {
    ...
    echo "Error: 'category_id' parameter is missing in the URL.";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['image']['tmp_name']) && !empty($_FILES['image']['tmp_name'])) {
        ...
        // Update query with image file name
        $update_query = "UPDATE categories SET category_name=?, description=?, image=? WHERE category_id=?";
        $stmt = $conn->prepare($update_query);
        $stmt->bind_param("sssi", $name, $description, $fileName, $category_id);
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                    <div class="card-body">
                        <div class="form-group">
                          ...
                          <input class="form-control form-control-lg" id="name" name="name" type="text" placeholder="Add Name here...." value="<?php echo htmlspecialchars($row['category_name']); ?>" required>
                          
                        </div>
                        <div class="form-group mb-3">
                            <label for="description">Description</label>
                            <textarea class="form-control form-size" id="description" name="description" placeholder="Add Description here...." rows="4" required><?php echo htmlspecialchars($row['description']); ?>
                            </textarea>
                          </div>
                </div> <!-- /.col -->
                </div>
                ...
                <a type="submit" href="category_list.php" class='btn btn-danger'>Dismiss</a>
              </div>
          </div>
