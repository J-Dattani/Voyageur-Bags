...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM tagline WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update query
    $update_query = "UPDATE tagline SET tagline=? WHERE id=?";
    ...
    if ($stmt->execute()) {
        ...
        header("location: ./tagline.php?id=$id");
        exit();
    }
}
?>
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="favicon.ico">  <link rel="icon" href="./bags.png" type="image/x-icon">    <title>Voyageur Bags - Admin</title>
    <!-- Simple bar CSS -->
                ...
                <div class="col-md-6">
                    <div class="card-body">
                         ...
                         <div class="form-group mb-3">
                            ...
                            <textarea  class="form-control form-size" id="tagline" name="tagline" placeholder="Add Tagline here...." rows="4"><?php echo ($row['tagline']); ?>
                            </textarea>
                  ...
                  <a type="submit" href="tagline.php" class='btn btn-danger'>Dismiss</a>
