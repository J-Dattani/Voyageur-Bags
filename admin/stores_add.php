...
<main class="main-content">
        ...
        <div class="col-12">
          ...
          <div class="card shadow mb-4">
            <div class="card-header">
              <strong class="card-title">Add Store Location</strong>
            </div>
  ...
  unset($_SESSION['status_code']);
            ...
            <form  enctype="multipart/form-data" action="stores.php" method="post">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                    <div class="card-body">
                        <div class="form-group">
                          ...
                          <input class="form-control form-control-lg" id="location" name="location" type="text" placeholder="Add Name here....">
                        </div>
                        <div class="form-group">
                          <label for="phone">Phone number</label>
                          <input class="form-control form-control-lg" id="phone" name="phone" type="text" placeholder="Add Phone Number here....">
                        </div>
                </div> <!-- /.col -->
                </div>
