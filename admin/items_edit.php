...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $about_this_product = $_POST['about_this_product'];
    ...
    if (isset($_FILES['image']['tmp_name']) && !empty($_FILES['image']['tmp_name'])) {
        ...
        if (!in_array($fileType, $allowTypes)) {
            ...
            header("location: ./items_edit.php?id=$id");
            exit();
        }
        ...
        $update_query = "UPDATE items SET name=?, description=?, price=?, percentage=?, caption=?, category=?, about_this_product=?, item_weight=?, generic_name=?, image=? WHERE id=?";
        $stmt = $conn->prepare($update_query);
        $stmt->bind_param("ssdissssssi", $name, $description, $price, $percentage, $caption, $category, $about_this_product, $item_weight, $generic_name, $fileName, $id);
    } else {
        // Update query without image
        $update_query = "UPDATE items SET name=?, description=?, price=?, percentage=?, caption=?, category=?, about_this_product=?, item_weight=?, generic_name=? WHERE id=?";
        $stmt = $conn->prepare($update_query);
        $stmt->bind_param("ssdisssssi", $name, $description, $price, $percentage, $caption, $category, $about_this_product, $item_weight, $generic_name, $id);
    }
    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                          ...
                          <div class="form-group mb-3">
                            ...
                            <textarea class="form-control form-size" id="caption" placeholder="Add Caption here" name="caption" rows="4"><?php echo htmlspecialchars($row['caption']); ?>                            
                            </textarea>
                          </div>
                </div> <!-- /.col -->
                </div>
                ...
                <p class="mb-2"><strong>Categories</strong>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <?php   while ($rows = mysqli_fetch_assoc($catRes)) {
          echo '<option value="'.$rows['category_id'].'">'.$rows['category_name'].'</option>';
                ...
                <div class="form-group mb-3">
                            ...
                            <textarea style="position: relative; bottom:5px;" class="form-control form-size" id="generic_name" name="generic_name" placeholder="Add Generic Name here...." rows="4"><?php echo $row['generic_name']; ?></textarea>
                          </div>
            </div>
        </div>
        ...
        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control form-size" id="about_this_product" name="about_this_product" placeholder="Type here...." rows="4"><?php echo htmlspecialchars($row['about_this_product']); ?></textarea>
                          </div>
            <label for="item_weight">Item Weight</label>
                ...
                <div class="input-group mb-3" style="width: 540px;">
                        ...
                        <div class="input-group-prepend">
                                      ...
                                      <input placeholder="Enter Item Weight" name="item_weight" id="item_weight" type="text" class="form-control"   value="<?php echo $row['item_weight']; ?>">
        ...
        <label>Price</label>  
          <div class="input-group mb-3" style="width: 540px;">
                ...
                <div class="input-group mb-3" style="width: 540px;">
                        ...
                        <input value="<?php echo htmlspecialchars($row['percentage']); ?>" name="percentage" id="percentage" type="text" class="form-control">
                        <div class="input-group-append">
                          <span class="input-group-text">%</span>
                        </div>
                      </div>
                      <button type="submit" class="btn btn-primary">Update</button>
                      <a type="submit" href="items_list.php" class='btn btn-danger'>Dismiss</a>
