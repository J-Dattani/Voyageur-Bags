...
<main class="main-content">
  ...
  unset($_SESSION['status_code']);
            ...
            <form  enctype="multipart/form-data" action="team.php" method="post">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control form-control-lg" id="designation" name="designation" type="text" placeholder="Add Designation here....">
                        </div>
                </div> <!-- /.col -->
                </div>
